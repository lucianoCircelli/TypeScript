...
src/core/some_decl.d.ts
  Matched by include pattern '**/*' in 'src/core/tsconfig.json'
[[90m12:00:41 AM[0m] Project 'src/logic/tsconfig.json' is out of date because oldest output 'src/logic/tsconfig.tsbuildinfo' is older than newest input 'src/core'

[[90m12:00:42 AM[0m] Building project '/src/logic/tsconfig.json'...
...
src/logic/index.ts
  Matched by include pattern '**/*' in 'src/logic/tsconfig.json'
[[90m12:00:48 AM[0m] Project 'src/tests/tsconfig.json' is out of date because oldest output 'src/tests/tsconfig.tsbuildinfo' is older than newest input 'src/core'

[[90m12:00:49 AM[0m] Building project '/src/tests/tsconfig.json'...
...
[[90m12:00:56 AM[0m] Project 'src/core/tsconfig.json' is out of date because oldest output 'src/core/tsconfig.tsbuildinfo' is older than newest input 'src/core/index.ts'

[[90m12:00:57 AM[0m] Building project '/src/core/tsconfig.json'...

[[90m12:01:03 AM[0m] Updating unchanged output timestamps of project '/src/core/tsconfig.json'...
...
[[90m12:01:14 AM[0m] Project 'src/core/tsconfig.json' is up to date because newest input 'src/core/index.ts' is older than oldest output 'src/core/tsconfig.tsbuildinfo'

[[90m12:01:15 AM[0m] Project 'src/logic/tsconfig.json' is up to date because newest input 'src/logic/index.ts' is older than oldest output 'src/logic/tsconfig.tsbuildinfo'

[[90m12:01:16 AM[0m] Project 'src/tests/tsconfig.json' is up to date because newest input 'src/tests/index.ts' is older than oldest output 'src/tests/tsconfig.tsbuildinfo'
